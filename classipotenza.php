...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Classi potenza</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    <div class="row">
        <div class="col-lg-12 col-md-12">
            ...
            <table id="table-classipotenza"
                   data-toggle="table-classipotenza"
                   data-method="GET"
                   ...
                   data-url="get_table_data.php?tabella=classipotenza"
                   data-click-to-select="true"
            >
                <thead>
                <tr>
                    <th data-field="state" data-radio="true"></th>
                    <th data-field="idclassepotenza" data-align="center" data-visible="false">ID Classe potenza</th>
    ...
    <script type="text/javascript">
        var oForm = {
            "table":"classipotenza",
            "labelForNew":"Nuova classe potenza",
            "labelForEdit":"Modifica classe potenza",
            "keyfield":"idclassepotenza",
            "autoincrement":"true",
            "buttons": [
            ...
            "panels":[
                {
                    "name": "classepotenza", "description":"Classe potenza", "collapsable":"false","collapsed":"false",
                    "rules": {
                    ...
                    "rows": [
                        {"cells":[
                            {"name": "idcilindrata", "label": "Cilindrata", "labelsize":"2","fieldsize":"10", "type": "select", "selectParams": {
                                "source": "table",
                                "table":"cilindrate",
                        ...
                        {"cells":[
                            {"name": "idtipoalimentazione", "label": "Tipo alimentazione", "labelsize":"2","fieldsize":"10", "type": "select", "selectParams": {
                                "source": "table",
