...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Gruppi età veicolo</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    <div class="row">
        <div class="col-lg-12 col-md-12">
            ...
            <table id="table-gruppietaveicolo"
                   data-toggle="table-gruppietaveicolo"
                   data-method="GET"
                   ...
                   data-url="get_table_data.php?tabella=gruppietaveicolo"
                   data-click-to-select="true"
            >
                <thead>
                <tr>
                    <th data-field="state" data-radio="true"></th>
                    <th data-field="idgruppoetaveicolo" data-align="center" data-visible="false">ID Gruppo Età Veicolo</th>
    ...
    <script type="text/javascript">
        var oForm = {
            "table":"gruppietaveicolo",
            "labelForNew":"Nuovo gruppo età veicolo",
            "labelForEdit":"Modifica gruppo età veicolo",
            "keyfield":"idgruppoetaveicolo",
            "autoincrement":"true",
            "buttons": [
            ...
            "panels":[
                {
                    "name": "gruppoetaveicolo", "description":"Gruppo età veicolo", "collapsable":"false","collapsed":"false",
                    "rules": {
