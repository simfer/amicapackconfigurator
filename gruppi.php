...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            ...
            <table id="table-gruppi"
                   data-toggle="table-gruppi"
                   data-method="GET"
                   ...
                   data-url="get_table_data.php?tabella=gruppi"
                   data-click-to-select="true"
            >
                <thead>
                <tr>
                    <th data-field="state" data-radio="true"></th>
                    <th data-field="idgruppo" data-align="center" data-visible="false">ID Gruppo</th>
    ...
    <script type="text/javascript">
        var oForm = {
            "table":"gruppi",
            "labelForNew":"Nuovo gruppo",
            "labelForEdit":"Modifica gruppo",
            "keyfield":"idgruppo",
            "autoincrement":"true",
            "buttons": [
            ...
            "panels":[
                {
                    "name": "gruppo", "description":"Gruppo", "collapsable":"false","collapsed":"false",
                    "rules": {
