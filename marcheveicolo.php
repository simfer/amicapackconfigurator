...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Marche veicolo</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    <div class="row">
        <div class="col-lg-12 col-md-12">
            ...
            <table id="table-marcheveicolo"
                   data-toggle="table-marcheveicolo"
                   data-method="GET"
                   ...
                   data-url="get_table_data.php?tabella=marcheveicolo"
                   data-click-to-select="true"
            >
                <thead>
                <tr>
                    <th data-field="state" data-radio="true"></th>
                    <th data-field="idmarcaveicolo" data-align="center" data-visible="false">ID Marca Veicolo</th>
    ...
    <script type="text/javascript">
        var oForm = {
            "table":"marcheveicolo",
            "labelForNew":"Nuova marca veicolo",
            "labelForEdit":"Modifica marca veicolo",
            "keyfield":"idmarcaveicolo",
            "autoincrement":"true",
            "buttons": [
            ...
            "panels":[
                {
                    "name": "marcaveicolo", "description":"Marca veicolo", "collapsable":"false","collapsed":"false",
                    "rules": {
