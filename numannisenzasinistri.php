...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Num. anni senza sinistri</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    <div class="row">
        <div class="col-lg-12 col-md-12">
            ...
            <table id="table-numannisenzasinistri"
                   data-toggle="table-numannisenzasinistri"
                   data-method="GET"
                   ...
                   data-url="get_table_data.php?tabella=numannisenzasinistri"
                   data-click-to-select="true"
            >
                <thead>
                <tr>
                    <th data-field="state" data-radio="true"></th>
                    <th data-field="idnumannisenzasinistri" data-align="center" data-visible="false">ID Num. Anni Senza Sin.</th>
    ...
    <script type="text/javascript">
        var oForm = {
            "table":"numannisenzasinistri",
            "labelForNew":"Nuovo numero anni senza sinistri",
            "labelForEdit":"Modifica numero anni senza sinistri",
            "keyfield":"idnumannisenzasinistri",
            "autoincrement":"true",
            "buttons": [
            ...
            "panels":[
                {
                    "name": "numannisenzasinistri", "description":"Num. anni senza sinistri", "collapsable":"false","collapsed":"false",
                    "rules": {
