...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Massimali</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    <div class="row">
        <div class="col-lg-12 col-md-12">
            ...
            <table id="table-massimali"
                   data-toggle="table-massimali"
                   data-method="GET"
                   ...
                   data-url="get_table_data.php?tabella=massimali"
                   data-click-to-select="true"
            >
                <thead>
                <tr>
                    <th data-field="state" data-radio="true"></th>
                    <th data-field="idmassimale" data-align="center" data-visible="false">ID Massimale</th>
    ...
    <script type="text/javascript">
        var oForm = {
            "table":"massimali",
            "labelForNew":"Nuova massimale",
            "labelForEdit":"Modifica massimale",
            "keyfield":"idmassimale",
            "autoincrement":"true",
            "buttons": [
            ...
            "panels":[
                {
                    "name": "massimale", "description":"Massimale", "collapsable":"false","collapsed":"false",
                    "rules": {
