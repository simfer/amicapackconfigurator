...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Num. sinistri denunciati</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    <div class="row">
        <div class="col-lg-12 col-md-12">
            ...
            <table id="table-numsinistridenunciati"
                   data-toggle="table-numsinistridenunciati"
                   data-method="GET"
                   ...
                   data-url="get_table_data.php?tabella=numsinistridenunciati"
                   data-click-to-select="true"
            >
                <thead>
                <tr>
                    <th data-field="state" data-radio="true"></th>
                    <th data-field="idnumsinistridenunciati" data-align="center" data-visible="false">ID Num. Sinistri Den.</th>
    ...
    <script type="text/javascript">
        var oForm = {
            "table":"numsinistridenunciati",
            "labelForNew":"Nuovo numero sinistri denunciati",
            "labelForEdit":"Modifica numero sinistri denunciati",
            "keyfield":"idnumsinistridenunciati",
            "autoincrement":"true",
            "buttons": [
            ...
            "panels":[
                {
                    "name": "numsinistridenunciati", "description":"Num. sinistri denunciati", "collapsable":"false","collapsed":"false",
                    "rules": {
